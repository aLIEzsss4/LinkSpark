...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("Synthesis")));
bytes32 constant SynthesisTableId = _tableId;
...
library Synthesis {
  ...
  /** Get the full data */
  function get() internal view returns (SynthesisData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](0);
  ...
  function get(IStore _store) internal view returns (SynthesisData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](0);
  ...
  function set(SynthesisData memory _table) internal {
    set(_table.duration, _table.effect);
  }

  /** Set the full data using the data struct (using the specified store) */
  function set(IStore _store, SynthesisData memory _table) internal {
    set(_store, _table.duration, _table.effect);
  }

  /** Decode the tightly packed blob using this table's schema */
  function decode(bytes memory _blob) internal pure returns (SynthesisData memory _table) {
