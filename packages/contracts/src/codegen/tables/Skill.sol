...
library Skill {
  ...
  /** Get cooldown */
  function getCooldown() internal view returns (bytes32 cooldown) {
    bytes32[] memory _keyTuple = new bytes32[](0);
  ...
  function getCooldown(IStore _store) internal view returns (bytes32 cooldown) {
    bytes32[] memory _keyTuple = new bytes32[](0);
  ...
  /** Set cooldown */
  function setCooldown(bytes32 cooldown) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
  ...
  function setCooldown(IStore _store, bytes32 cooldown) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
  ...
  function setEffect(bytes32 effect) internal {
    ...
    StoreSwitch.setField(_tableId, _keyTuple, 2, abi.encodePacked((effect)));
  }
  ...
  function setEffect(IStore _store, bytes32 effect) internal {
    ...
    _store.setField(_tableId, _keyTuple, 2, abi.encodePacked((effect)));
  }

  /** Get the full data */
  function get() internal view returns (SkillData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](0);
  ...
  function get(IStore _store) internal view returns (SkillData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](0);
  ...
  function set(bool exists, bytes32 cooldown, bytes32 effect) internal {
    bytes memory _data = encode(exists, cooldown, effect);
  ...
  function set(IStore _store, bool exists, bytes32 cooldown, bytes32 effect) internal {
    bytes memory _data = encode(exists, cooldown, effect);
  ...
  function set(SkillData memory _table) internal {
    set(_table.exists, _table.cooldown, _table.effect);
  }

  /** Set the full data using the data struct (using the specified store) */
  function set(IStore _store, SkillData memory _table) internal {
    set(_store, _table.exists, _table.cooldown, _table.effect);
  }
  ...
  function decode(bytes memory _blob) internal pure returns (SkillData memory _table) {
    ...
    _table.cooldown = (Bytes.slice32(_blob, 1));

    _table.effect = (Bytes.slice32(_blob, 33));
  }

  /** Tightly pack full data using this table's schema */
  function encode(bool exists, bytes32 cooldown, bytes32 effect) internal view returns (bytes memory) {
    return abi.encodePacked(exists, cooldown, effect);
  }
